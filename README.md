...
<table dir="rtl" style="text-align: right;">
  ...
  <tbody>
    <tr><td style="text-align: right;"><span dir="ltr"><code>alloca()</code><br><code>_alloca()</code></span></td><td style="text-align: right;">از <span dir="ltr"><code>malloc()</code></span> یا <span dir="ltr"><code>new()</code></span> در هیپ (heap) استفاده کنید، نه تخصیص روی پشته (stack) چون ممکن است به قاب‌های پشته آسیب برساند.</td></tr>
    <tr><td style="text-align: right;"><span dir="ltr"><code>scanf()</code><br><code>wscanf()</code><br><code>sscanf()</code><br><code>swscanf()</code><br><code>vscanf()</code><br><code>vsscanf()</code></span></td>
     <td style="text-align: right;">به جای توابع <span dir="ltr"><code>scanf()</code></span> از <span dir="ltr"><code>fgets()</code></span> استفاده کنید.</td></tr>
